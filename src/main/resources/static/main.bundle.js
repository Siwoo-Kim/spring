    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["K" /* NgModule */])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_6__angular_material__["a" /* MatCardModule */], __WEBPACK_IMPORTED_MODULE_6__angular_material__["b" /* MatListModule */],
            ],
            providers: [
                __WEBPACK_IMPORTED_MODULE_8__services_request_mapping_service__["a" /* RequestMappingService */],
            ],
...
var RequestMappingService = /** @class */ (function () {
    ...
    RequestMappingService.prototype.helloPost = function () {
        return this.http.post(RequestMappingService_1.url + "/hello", { greeting: 'Hello Spring' }, { params: { greeting: 'Hello Spring With Params!' } })
            .map(function (response) { console.log(response); console.log(response.json()); return response.json(); });
    };
